...
const PUBLISHER_ALIASES: Array<[RegExp, string]> = [
  ...
  // ── India: regional + mid-size national. Expanded so the prominence gate
  //    isn't biased toward English metros / silently suppressing Hindi +
  //    regional news that genuinely has 3+ outlets. ──
  [/\boutlook\b/i, "outlook"],
  [/firstpost/i, "firstpost"],
  [/the\s+quint|thequint/i, "the quint"],
  [/news\s*minute|newsminute/i, "the news minute"],
  [/free\s+press\s+journal/i, "free press journal"],
  [/mid[\s-]?day/i, "mid-day"],
  [/deccan\s+chronicle/i, "deccan chronicle"],
  [/the\s+statesman/i, "the statesman"],
  [/national\s+herald/i, "national herald"],
  [/the\s+federal/i, "the federal"],
  [/onmanorama|malayala\s+manorama|\bmanorama\b/i, "manorama"],
  [/mathrubhumi/i, "mathrubhumi"],
  [/the\s+hans\s+india/i, "hans india"],
  [/telangana\s+today/i, "telangana today"],
  [/etv\s+bharat/i, "etv bharat"],
  [/\btv9\b/i, "tv9"],
  [/navbharat\s+times|navbharat/i, "navbharat times"],
  [/jansatta/i, "jansatta"],
  [/prabhat\s+khabar/i, "prabhat khabar"],
  [/punjab\s+kesari/i, "punjab kesari"],
  [/\blokmat\b/i, "lokmat"],
  [/nai\s*dunia|naidunia/i, "naidunia"],
  // ── International ──
  [/\bbbc\b/i, "bbc"],
